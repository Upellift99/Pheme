...
1. Récupérer les mesures de couverture via `mcp__sonarqube__get_component_measures` (project key : `Upellift99_Pheme_e9ed11f1-ecc0-4d23-bc08-88705135bbc5`, metrics : `new_coverage,new_uncovered_lines,new_lines_to_cover`)
